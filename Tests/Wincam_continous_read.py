...
sol_x, sol_y = gatorspy.fit_beam_profile_ODR(z, wx, z, wy, w0guess=239e-6, z0guess=0.1, zRguess=0.2, wx_std=wx_std, wy_std=wy_std, z_std=0.005, title='Reflection',print_results=True,frac_err=0.02)# Print the results with errors
...
qx,qy=gatorspy.calculate_q(w0x=sol_x[0],w0y=sol_y[0],zx=sol_x[1],zy=sol_y[1])
qx_cav,qy_cav=gatorspy.calculate_q(w0x=650e-6,w0y=647e-6,zx=0.19,zy=0.19)
